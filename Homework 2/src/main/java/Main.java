...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        massGood[2] = new ClickableObject("Ноутбуки", "urlLapt", "https://www.ozon.ru/category/noutbuki-15692/"); /* Создание объектов класса
                                                                                                                                             ClickableObject - категории
                                                                                                                                             товаров. */
        ...
        massSearch[2] = new ClickableObject("Мебель", "urlFurniture", ""); /* Создание объектов класса
                                                                                                     ClickableObject -
                                                                                                     категории поиска. */
        ...
        massDropObj[2] = new DropdownObject("Телевизоры"); /* Создание объектов класса DropdownObject - категории
                                                                   выпадающего списка. */

        InputObject find = new InputObject("Главный поиск", ""); /* Создание объекта класса InputObject - поле
                                                                             для ввода. */
        try {
            while (true) {
